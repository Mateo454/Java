...
import java.util.logging.Level; //Sugerencia trycatch para usar pa funcion .sleep de thread y darle tiempo a el hilo 
...
public class Procesar extends javax.swing.JFrame {
    ...
    public Procesar() { //Metodo para ingresar los datos ala tabla Ingreso y pintarlos
        initComponents();
        ...
        jTFCapturaQuantum.grabFocus();//Tener el espacio del textField seleccionado 
    }
     ...
     */
    @SuppressWarnings("unchecked")//codigo generado para la exceptcion trycath
    ...
    private void jBIniciarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBIniciarActionPerformed
        // TODO add your handling code here:
        new Thread(new Hilo()).start(); //Crea un nuevo objeto tipo hilo y lo implementa
        Iniciar();
    ...
    @Override
    public void run(){
        int bandera=1; //Estado de while que indica si se puede seguir o no
...
public void Borrar(int c){ //Elimina los registros de la tabla procesos
   ...
   public void Barra(int rafaga, int residuo){ //Calcula porcentaje de la barra y su progreso
        ...
        int porcentaje=100-(valor*residuo);//Calcular el progreso
    ...
    public void Iniciar(){ //Inicia la secuencia de procesos y esconde opciones que ya no se necesitaran
